...
const AccountCenter: React.FC = () => {
    ...
    const handleAvatarChange = (info: UploadChangeParam<UploadFile>) => {
        ...
        if (info.file.status === 'done') {
            ...
            if (avatarUrl) {
                updateUserAvatar({userAvatar: avatarUrl}).then(() => {
                ...
                <Col lg={17} md={24}>
                    <Card bordered={false} style={{marginBottom: 24}}>
                        <Tabs defaultActiveKey="1">
                            ...
                            {/* 好友申请 */}
                            <TabPane tab={`好友申请${friendRequests.length > 0 ? ` (${friendRequests.length})` : ''}`}
                                     key="4">
                                <ProCard bordered headerBordered>
                                    {requestsLoading ? (
                                        ...
                                        <List
                                            ...
                                            renderItem={(request) => (
                                                ...
                                                >
                                                    <List.Item.Meta
                                                        avatar={<Avatar size={48} src={request.requester?.userAvatar}
                                                                        icon={<UserOutlined/>}/>}
                                                        title={
                                                            <Space>
