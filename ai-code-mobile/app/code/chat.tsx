            ...
            >
                ...
                >
                    ...
                    <Text style={styles.messageTime}>
                        {message.createTime ? new Date(message.createTime).toLocaleTimeString([], {
                            hour: '2-digit',
                            minute: '2-digit'
                        }) : ''}
                    </Text>
    ...
    return (
        ...
        >
            ...
            <View style={styles.tabHeader}>
                ...
                >
                    <Text
                        style={[styles.tabHeaderText, activeTab === 0 && styles.activeTabHeaderText, activeTab === 0 && {color: themeColor}]}>对话</Text>
                </TouchableOpacity>
                {/**
                 * 预览标签页按钮
                 * 点击切换到预览标签页
                ...
                >
                    <Text
                        style={[styles.tabHeaderText, activeTab === 1 && styles.activeTabHeaderText, activeTab === 1 && {color: themeColor}]}>预览</Text>
                </TouchableOpacity>
                {/**
                 * 评论标签页按钮
                 * 点击切换到评论标签页
                ...
                >
                    <Text
                        style={[styles.tabHeaderText, activeTab === 2 && styles.activeTabHeaderText, activeTab === 2 && {color: themeColor}]}>评论</Text>
                </TouchableOpacity>
            </View>
